(async () => {
  ...
  try {
    ...
    const token = j.token;
    console.log("Got token, creating article...");

    const article = {
      title: "E2E Test Article " + Date.now(),
      content:
        '<p>Test content with inline image <img src="https://i.ibb.co/Z699thkc/original-725220a9858acb4f0569569ea0afdc83.png"></p>',
    ...
    const found = gj.data.find(
      (a) => a.title && a.title.startsWith("E2E Test Article")
    );
